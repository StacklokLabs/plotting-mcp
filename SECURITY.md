...
["Report a Vulnerability"](https://github.com/StacklokLabs/plotting-mcp/security/advisories/new)
tab.
...
- Create a new
  ...
  `https://github.com/StacklokLabs/plotting-mcp/security/advisories/new`
